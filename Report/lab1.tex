...
%	      \end{center}
   ...
   % \begin{center}
         ...
         \captionof{figure}{Graphic showing the cost of each strategy.}
			      \includegraphics[scale=0.7]{images/DensityOnSolutionCostOnDifferentStrategies.png}
       ...
       \begin{minipage}{0.5\textwidth}
			      \centering
			      \captionof{figure}{Boxplot on different solution costs by each search strategy.}\includegraphics[scale=0.7]{images/BoxplotOnSolutionCostOnDifferentStrategies.png}
...
%	\item Rough description of the main ideas of the algorithm to solve this problem as it would
 ...
 % \begin{center}
		      \begin{minipage}{0.5\textwidth}
			      \centering
			      \captionof{figure}{Density graph on the nodes generated by each strategy.}\includegraphics[scale=0.7]{images/densityOnNodesGeneratedOnDifferentStrategies.png}
