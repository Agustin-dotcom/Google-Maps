...
\begin{center}
		      \begin{figure}[!ht]
			      \centering
			      \caption{Class Diagram showing Inheritance.}\includegraphics[scale=0.7]{images/lab1intelligentsystems Class diagram.png}
...
We have got several parameters we can use to our benefit to compare different strategies based on different metrics. Take Figure \ref{fig:boxplot} below, for instance. We can see how \textbf{DepthFirst} search is the strategy with most generated nodes considering all problems of different dimensions. We can see, specifically, in Figure \ref{fig:depthFirstSucks} how \textbf{DepthFirst} is really bad at huge problems finding paths with really high costs compared to all other search strategies.
 \begin{center}
		      \begin{figure}[h]
			      \centering
			      \caption{Graphic showing the nodes generated of each strategy.}\includegraphics[scale=0.7]{images/boxplotNodesGeneratedDifferentStrategies.png}
      ...
      % \newpage
       ...
       \begin{figure}[!ht]
			      \centering
          \caption{Graphic showing the different execution times of different strategies.}
			      \includegraphics[scale=0.7]{images/BoxplotOnExecutionTimeOnDifferentStrategies.png}
       ...
       \begin{figure}[!ht]
			      \centering
			      \caption{Boxplot on different solution costs by each search strategy.}\includegraphics[scale=0.7]{images/BoxplotOnSolutionCostOnDifferentStrategies.png}
...
%	\item Rough description of the main ideas of the algorithm to solve this problem as it would
 ...
 \begin{center}
		      \begin{figure}[!ht]
			      \centering
			      \caption{Density graph on the nodes generated by each strategy.}\includegraphics[scale=0.7]{images/densityOnNodesGeneratedOnDifferentStrategies.png}
...
\end{lstlisting}
	      ...
	      \begin{center}
		      \begin{figure}[!ht]
			      ...
			      \caption{Graphic showing the cost of each strategy.}
			      \label{fig:complexity-graph}
		      \end{figure}
	      \end{center}
        \begin{center}
		      \begin{figure}[!ht]
        \caption{Density graphic showing solution cost of each strategy within a certain type of problem.
			      \centering
			      \includegraphics[scale=0.7]{images/GeomBarDodgeOnStrategies.png}
			      }
...
\end{itemize}
            \begin{center}
		      \begin{figure}[!ht]
			      \centering
			      \includegraphics[scale=0.7]{images/BarPlotDodgeNodesExpandedWithinEachTypeOfProblem.png}
